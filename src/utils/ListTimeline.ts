...
export const listTimeline: ITimeline[] = [
  ...
  {
    time: "May 2021",
    title: "Course: Angular 9",
    body: `I took the Angular course to get a base of the framework, main concepts, syntax and in the future I would delve deeper into studying its documentation.

    During the Cod3r course, some components, services, directives, routing, among other concepts, were applied, aiming to deepen the knowledge base in Angular.`,
    link: "https://www.cod3r.com.br/certificates/xpukr3qzcz",
  },
  {
    time: "May 2022",
    title: "Course: Intensive Next.js & React",
    body: `When I took the Next.js Intensive course, my idea was to consolidate my knowledge.

    And to certify my knowledge, at that point I had already developed other projects with NodeJs, both using Angular, React and recently NextJs.

    When developing with Node, I particularly prefer using TypeScript`,
    link: "https://www.cod3r.com.br/certificates/mk565mciz7",
  },
  {
    time: "September 2022",
