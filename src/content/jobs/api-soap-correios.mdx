---
title: API Correios (SOAP)
description: API developed in Java to consume SOAP WebServices from the postal service to calculate shipping.
date: 2017-12-20
imgSrc: /cards/SOAP_ws.png
---

## About
API developed in Java to consume SOAP WebServices from the postal service to calculate shipping

Java 8 was used, an interface made with javax.swing and the WSDL imported from the official postal website.
...
[Scheema to Object](https://www.jsonschema2pojo.org/)


> Project: developed by test interview